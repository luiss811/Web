...
import { BarChart2, Activity, Eye, Search, ShoppingBag, Database, ShieldAlert, Cpu } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="space-y-4 mb-10 text-center max-w-3xl mx-auto">
        ...
        <p className="text-sm text-mineral-500 dark:text-mineral-400 leading-relaxed">
          Monitoreo de la actividad, tráfico de usuarios, interacciones del carrito de compras.
        </p>
      </div>
